<template>
  <nav class="fixed top-0 z-50 w-full bg-gradient-to-r from-indigo-600 to-purple-600 border-b border-indigo-500 shadow-lg">
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
          <div class="flex items-center justify-between">
              <div class="flex items-center justify-start rtl:justify-end">
                  <a href="" class="flex ms-2 md:me-24">
                      <span class="self-center text-xl sm:text-2xl whitespace-nowrap text-white font-bold">Sohrabi Gym</span>
                  </a>
              </div>
          </div>
      </div>
  ...
  <aside id="logo-sidebar" class="fixed top-0 right-0 z-40 w-64 h-screen pt-20 transition-transform translate-x-full bg-gradient-to-b from-indigo-50 to-white border-l border-indigo-100 sm:translate-x-0 shadow-xl" aria-label="Sidebar">
          ...
          <ul class="space-y-2 font-medium">
              <li v-for="item in menuItems" :key="item.path">
                  ...
                  >
                      ...
                      <span v-if="$route.path === item.path" class="absolute left-3 w-1 h-6 bg-indigo-600 rounded-full"></span>
                  </router-link>
              </li>
          </ul>
      </div>
      ...
      <div class="absolute bottom-0 w-full p-4 border-t border-indigo-100 bg-white">
          <div class="flex items-center justify-end">
              ...
              <div class="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center border-2 border-indigo-200">
