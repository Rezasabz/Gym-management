<template>
  ...
  <div class="overflow-x-auto w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
      <div
        class="bg-gradient-to-br from-purple-50 to-white shadow-lg rounded-xl p-4 flex items-center space-x-4 w-full max-w border border-blue-100 transition-all hover:shadow-xl"
      >
        <!-- آیکون -->
        ...
        <div class="flex-1">
          ...
          <p class="custom-rtl text-xl font-semibold text-gray-900">
            {{ fetch_new_members_count }} نفر
          </p>
        </div>
      </div>
      <div
        class="bg-gradient-to-br from-green-50 to-white shadow-lg rounded-xl p-4 flex items-center space-x-4 w-full max-w border border-blue-100 transition-all hover:shadow-xl"
      >
        <!-- آیکون -->
        ...
        <div class="flex-1">
          ...
          <p class="custom-rtl text-xl font-semibold text-gray-900">
            {{ current_month_revenue }} تومان
          </p>
        </div>
      </div>
      <div
        class="bg-gradient-to-br from-blue-50 to-white shadow-lg rounded-xl p-4 flex items-center space-x-4 w-full max-w border border-blue-100 transition-all hover:shadow-xl"
      >
        <!-- آیکون -->
    ...
    <div class="grid grid-cols-3 gap-4">
      ...
      <div class="col-span-2 p-4 bg-white shadow-lg rounded-xl border border-blue-100">
        <div
          class="p-3 bg-gradient-to-r from-green-50 to-white rounded-xl flex items-center space-x-4 w-full max-w"
        >
          <!-- آیکون -->
      ...
      <div class="p-4 bg-white shadow-lg rounded-xl border border-blue-100">
        <div
          class="p-3 bg-gradient-to-r from-red-50 to-white rounded-xl flex items-center space-x-4 w-full max-w-md"
        >
          <!-- آیکون -->
        ...
        <div class="card-body p-6">
          ...
          <div class="flex justify-between items-center">
            ...
            <select
              ...
              @change="updateChart"
              class="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700"
            >
