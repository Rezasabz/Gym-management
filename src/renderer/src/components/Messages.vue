      ...
      <div class="card-body space-y-6">
        ...
        <div class="form-control">
          <label class="label justify-end">
            <span class="label-text font-semibold">متن پیامک</span>
          </label>
          <textarea 
            v-model="message" 
        ...
        <div class="form-control">
          <label class="label justify-end">
            <span class="label-text font-semibold">ارسال به</span>
          </label>

          <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            <label class="card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer">
              <div class="card-body p-4 flex items-center justify-end gap-2">
                <input 
                  type="radio" 
                  name="send-to" 
                  ...
                  value="all"
                >
                <span class="font-semibold">همه اعضا</span>
              </div>
            </label>
            ...
            <label class="card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer">
              <div class="card-body p-4 flex items-center justify-end gap-2">
                <input 
                  ...
                  value="active"
                >
                <span class="font-semibold">اعضای فعال</span>
              </div>
            </label>
            ...
            <label class="card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer">
              <div class="card-body p-4 flex items-center justify-end gap-2">
                <input 
                  ...
                  value="custom"
                >
                <span class="font-semibold">انتخاب دستی</span>
              </div>
            </label>
          </div>
              ...
              <table class="table w-full text-right">
                ...
                <tbody>
                  <tr v-for="user in users" :key="user.id">
                    ...
                    <td class="font-semibold">{{ user.phone }}</td>
            ...
            <label class="card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer">
              <div class="card-body p-4 flex items-center justify-end gap-2">
                <input 
                  ...
                  value="now"
                >
                <span class="font-semibold">همین حالا</span>
              </div>
            </label>
            ...
            <label class="card bg-base-200 hover:bg-base-300 transition-colors cursor-pointer">
              <div class="card-body p-4 flex items-center justify-end gap-2">
                <input 
                  ...
                  value="scheduled"
                >
                <span class="font-semibold">زمانبندی شده</span>
              </div>
            </label>
          </div>
